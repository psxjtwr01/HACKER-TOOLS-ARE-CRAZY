...
def xtrn(dccommands):
 ...
 |  __ \ (_)                                           | |   | |  | |             | |               |__   __|           | |     
 | |  | | _  ___   ___  ___   _ __   _ __    ___   ___ | |_  | |__| |  __ _   ___ | | __ ___  _ __     | |  ___    ___  | | ___ 
 | |  | || |/ __| / __|/ _ \ | '_ \ | '_ \  / _ \ / __|| __| |  __  | / _` | / __|| |/ // _ \| '__|    | | / _ \  / _ \ | |/ __|
 | |__| || |\__ \| (__| (_) || | | || | | ||  __/| (__ | |_  | |  | || (_| || (__ |   <|  __/| |       | || (_) || (_) || |\__ \
 |_____/ |_||___/ \___|\___/ |_| |_||_| |_| \___| \___| \__| |_|  |_| \__,_| \___||_|\_\\___||_|       |_| \___/  \___/ |_||___/
    ...
    -- Made by Drexxy シ
        ...
        print(r"""_ """ * 80 + "")
        write(r"q is to return to C:\Terminal\main ")
        ...
        if choice == "q":
            break
        dccommands.get(choice, lambda: write("Invalid choice. Please try again."))()
